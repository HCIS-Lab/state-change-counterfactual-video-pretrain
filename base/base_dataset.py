...
class TextVideoDataset(Dataset):
    def __init__(self,
                 ...
                 reader='decord',
                 neg_param=None,
                 tau_a=1.0, #Only for EPIC-AA
                 tau_o=10.0, #Only for EPIC-AA
                 ):
...
def read_frames_cv2_howto100m(video_path, num_frames, sample,
...
def read_frames_cv2_epic(video_path, start_frame, stop_frame, num_frames, sample='rand', fix_start=None):
    ...
    for index in frame_idxs:
        ...
        img_name = str(index).zfill(10) + '.png'
...
video_reader = {
    ...
    'cv2_howto100m': read_frames_cv2_howto100m,
