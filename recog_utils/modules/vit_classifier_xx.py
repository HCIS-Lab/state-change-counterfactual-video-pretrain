...
class vit_classifier(nn.Module):
    def __init__(self, num_frames, num_segments, device):
        ...
        self.tin = nn.Transformer(d_model=768, nhead=2, num_encoder_layers=2, num_decoder_layers=2, dim_feedforward=256, dropout=0.1, batch_first=True)
        self.tout = nn.Transformer(d_model=768, nhead=2, num_encoder_layers=2, num_decoder_layers=2, dim_feedforward=256, dropout=0.1, batch_first=True)
        self.in_proj = nn.Linear(256, 768)
        ...
        self.proj = nn.Linear(768, 10)  # Final classification layer
        self.device = device
