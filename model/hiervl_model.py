...
from base.base_model_hiervl import BaseModel
from model.video_transformer_hiervl import SpaceTimeTransformer
from model.vit_hiervl import VisionTransformer
...
class FrozenInTime(BaseModel):
    ...
    def forward(self, data, video_only=True, return_embeds=True, do_aggregation=False, batch_size=None):
