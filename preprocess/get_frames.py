...
parser.add_argument('--vpath', default='/nfs/wattrel/data/md0/datasets/action_seg_datasets/BreakfastII_15fps_qvga_sync')
parser.add_argument('--fpath', default='/nfs/wattrel/data/md0/datasets/action_seg_datasets/BreakfastII_15fps_qvga_sync/frames')
