...
def load_milnce():
    net = S3D('/nfs/wattrel/data/md0/kung/state-aware-video-pretrain/pretrained/s3d_dict.npy', 512)
    net.load_state_dict(th.load('/nfs/wattrel/data/md0/kung/state-aware-video-pretrain/pretrained/s3d_howto100m.pth'))
    return net
